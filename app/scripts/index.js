...
const createStar = async () => {
  ...
  App.setStatus("New Star Owner is <b>" + account + "</b>.");
}
...
const lookupStar = async () => {
  ...
  App.setStarLookUpStatus("This star is called: <b>" + starName + "</b>.");
}
...
const App = {
  ...
  setStarLookUpStatus: function (message) {
    const status = document.getElementById('starLookUpStatus')
    status.innerHTML = message
  },
